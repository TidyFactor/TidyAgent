...
3. **Verify Stdio Handshake**:
   ...
   - Confirm 8 tools registered: `tidy_recall`, `tidy_memorize`, `tidy_get_context`, `tidy_switch_context`, `tidy_task_add`, `tidy_task_list`, `tidy_exec_subagent`, `tidy_db_stats`.
...
- [ ] All 8 tools declared with inputSchema
